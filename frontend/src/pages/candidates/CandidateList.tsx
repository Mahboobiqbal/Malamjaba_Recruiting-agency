        ...
        <table className="w-full text-left text-sm">
          <thead className="border-b bg-secondary">
            <tr>
              ...
              <th className="px-4 py-3 font-medium text-slate-600">Registered</th>
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr><td colSpan={7} className="px-4 py-8 text-center text-slate-500">No candidates found</td></tr>
            ) : (
              data?.items.map((c) => (
                <tr key={c.id} className="border-b hover:bg-secondary">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      <Link to={`/candidates/${c.id}`} className="text-slate-400 hover:text-primary">
                        <Eye className="h-4 w-4" />
                      </Link>
                      <Link to={`/candidates/${c.id}/edit`} className="text-slate-400 hover:text-amber-600">
