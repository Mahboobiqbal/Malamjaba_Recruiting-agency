  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6 shadow-sm">
        <h3 className="mb-4 text-lg font-semibold text-slate-800">Agent Performance</h3>
        <table className="w-full text-left text-sm">
          <thead className="border-b bg-secondary">
            <tr>
              <th className="px-4 py-3 font-medium text-slate-600">Agent Code</th>
              <th className="px-4 py-3 font-medium text-slate-600">Agent Name</th>
              <th className="px-4 py-3 font-medium text-slate-600">Candidates</th>
            </tr>
          </thead>
          <tbody>
            {agents?.map((a: any) => (
