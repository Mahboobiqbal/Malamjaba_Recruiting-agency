...
export default function MedicalTokenCreate() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <h2 className="text-2xl font-bold text-slate-800">New Medical Token</h2>
      <form onSubmit={handleSubmit} className="rounded-lg border bg-white p-6 shadow-sm">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700">Token Number</label>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700">Medical Center</label>
            <input type="text" value={form.medical_center} onChange={(e) => setForm({ ...form, medical_center: e.target.value })}
              className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary focus:outline-none" />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-700">Medical Date</label>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700">Medical Status</label>
